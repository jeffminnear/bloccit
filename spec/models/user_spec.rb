...
RSpec.describe User, type: :model do
  ...
  # Shoulda tests for relationship
  ...
  describe "#favorite_for(post)" do
    ...
    it "returns 'nil' if the user has not favorited the post" do
      different_user = User.create!(name: "Some guy", email: "something@bloccit.com", password: "helloworld" )
      expect(different_user.favorite_for(@post)).to be_nil
    end
