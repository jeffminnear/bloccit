...
RSpec.describe CommentsController, type: :controller do
  let(:my_user) { User.create!(name: "Bloccit User", email: "user@gloccit.com", password: "helloworld") }
  ...
  context "member doing CRUD on comment they don't own" do
    before do
      create_session(other_user)
    end

    describe "POST #create" do
      it "increases number of comments by 1" do
  ...
  context "admin doing CRUD on comment they don't own" do
    before do
      other_user.admin!
      create_session(other_user)
    end
